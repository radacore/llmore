  ...
  return (
    <div>
      <IntegrationHeader
        ...
        description="Pakai LLMore dengan Langchain untuk membangun aplikasi AI yang lebih kompleks seperti retrieval-augmented generation, agentic workflows, dan multi-step chains."
        surface="moss"
      />

      <p className="text-[11px] font-bold text-[#1009f6] uppercase tracking-[0.2em] mb-3">
        Python — ChatOpenAI dengan LLMore
      </p>
